...
def get_apod_info(image_id):
    ...
    image_path_query = "SELECT file_path FROM image_data WHERE id = ?;"
    db_cursor.execute(image_path_query, (image_id,))
    file_path_query_result = db_cursor.fetchone()

    # Retrieve title and explanation using the provided image_id
    image_info_query = """
